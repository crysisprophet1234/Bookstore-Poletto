	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.GET,  "/v3/books/**")).permitAll()
				.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.POST, "/v3/books/create")).hasRole("OPERATOR")
				.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.PUT,  "/v3/books/**/update")).hasRole("OPERATOR")
				.requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.PUT,  "/v3/books/**/change-status")).hasRole("OPERATOR")
			)
